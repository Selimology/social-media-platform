...
const Discover = () => {
  ...
  const activeTopic =
    'text-black border-gray-700 hover:text-white hover:bg-black hover:border-gray-100 border-[3px] cursor-pointer  flex items-center justify-center   px-4 py-2 w-full xl:w-auto rounded gap-2  border-2 rounded-full shadow-md xl:shadow-lg ';
  const anyTopic =
