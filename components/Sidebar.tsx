...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {toggleSidebar && (
        <div className=" flex flex-col w-20 mt-2 border-gray-100 border-l-2 xl:w-[400px] p-2 mb-12 justify-start ">
          <div className="xl:border-b-2 border-gray-200 xl:pb-4 xl:pr-4">
            <Link href="/">
